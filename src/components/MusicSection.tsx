  ...
  return <section className="pixel-section">
      ...
      <div className="w-full max-w-2xl pb-6">
        <Carousel className="relative px-10">
          <CarouselContent>
            {tracks.map(track => <CarouselItem key={track.id} className="transition-all duration-300 py-4 px-2">
                <div className="flex flex-col items-center overflow-visible h-full">
                  ...
                  <div className="flex gap-4 mt-3">
                    <a href={track.streamUrl} target="_blank" rel="noopener noreferrer" className="pixel-button text-xs px-3 py-1 inline-block">
                      ✧ listen
                    </a>
                    <a href={track.buyUrl} target="_blank" rel="noopener noreferrer" className="pixel-button text-xs px-3 py-1 inline-block">
                      ✧ buy
                    </a>
                  </div>
                </div>
      ...
      <div className="mt-6 py-4 border-t border-b border-pixel-purple/30 text-center max-w-md hover:border-pixel-purple/60 transition-all duration-300 md:flex md:flex-col md:items-center mx-0 px-0">
