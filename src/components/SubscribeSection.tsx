  ...
  return <section className="pixel-section">
      ...
      <div className="max-w-md w-full mb-6 text-center mx-auto">
        ...
        <div className="w-full flex justify-center">
          <Button onClick={handleRedirect} className="pixel-button !border-2 !border-black h-12 min-w-[200px] transition-all" disabled={loading}>
      ...
      <div className="mt-8 relative">
        ...
        <div className="border-2 border-pixel-purple/30 px-6 py-4 text-center max-w-sm hover:border-pixel-purple transition-all duration-300">
