...
const subscribeMessages = ["taking you backstage ✧₊˚｡", "next stop: the inner circle. ₊˚⊹♡", "welcome to the front row ☆彡", "just for you: the inside scoop. ❀", "stepping into the spotlight ✨"];
  ...
  return <section className="pixel-section">
      ...
      <div className="mt-8 relative">
        ...
        <div className="border-2 border-pixel-purple/30 px-3 py-2 sm:px-6 sm:py-3 text-center max-w-[180px] sm:max-w-xs hover:border-pixel-purple transition-all duration-300 mx-auto">
          ...
          <p className="text-pixel-purple font-bold mt-2 text-xs break-words sm:text-sm">
